...
namespace WebEntryPoint
{
    ...
    { 
        ...
        public EntrypointService()
        {
            ...
            _cmdQueue = Helpers.Appsettings.CmdQueue();
        ...
        private void CheckHealth()
        {
            ...
            if (_entryQueue == null) queueSettings += Helpers.Appsettings.EntryQueueKey + ", ";
            if (_service1Queue == null) queueSettings += Helpers.Appsettings.Service1QueueKey + ", ";
            if (_service2Queue == null) queueSettings += Helpers.Appsettings.Service2QueueKey + ", ";
            if (_service3Queue == null) queueSettings += Helpers.Appsettings.Service3QueueKey + ", ";
            if (_exitQueue == null) queueSettings += ", " + Helpers.Appsettings.ExitQueueKey + ", ";
            if (_cmdQueue == null) queueSettings += ", " + Helpers.Appsettings.CmdQueueKey;
            ...
            if (Helpers.Appsettings.AllowedSocketListenerCsv() == null) throw new Exception("Websocket.Listeners not defined in app.config");
