...
namespace WebEntryPoint
{
    ...
    {
        private static readonly NLogWrapper.ILogger _logger = LogManager.CreateLogger(typeof(QueueController));
        ...
        public async Task<IHttpActionResult> Post()
        {
            ...
            string resultMsg = string.Format("WebApi: Done.", received.MessageId);
